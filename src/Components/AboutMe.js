        ...
        <div className="row g-0">
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p>
              Moving forward, I want to take my passion for community and my technical skills to provide solutions for our community and make technology more inclusive.</p>
